...
def read_write_heap(pid, search_string, replace_string):
    """
    Search for a string in a process's heap memory and replace it with another string.
    
    This function locates a target string within the heap memory of a specified process
    and overwrites it with a replacement string. The replacement string must not be longer
    ...
    Args:
        ...
        replace_string (str): The string to replace the search_string with. Must not be
